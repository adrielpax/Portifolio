    ...
    <>
      ...
      <main className="relative min-h-screen flex gap-4 justify-between font-mono">
        ...
        <div className="relative z-10 text-white w-full">
          ...
          {/* Grid */}
          <section className="flex flex-col items-center justify-center gap-4 items-start"
          >
              <MainCard />
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className=" bg-white/5 backdrop-blur-md border border-white/10 rounded-xl gap-4 p-6">
                ...
                <div className="flex flex-row gap-2 bg-black/5 backdrop-blur-md border border-white/10 rounded-xl p-6">
                  <img/>
                  <p>Sou um Profissional qualificado no desenvolvimento de applicações <br/>
                    de software interface de sistema e integração e comunicação de dados entre sistemas, mas minha historia nao começa assim... </p>
                </div>

                <div className="flex flex-row gap-2 bg-black/5 backdrop-blur-md border border-white/10 rounded-xl p-6">
                  <img/>
                  <p>Sou um Profissional qualificado no desenvolvimento de applicações 
                    de software interface de sistema e integração e comunicação de dados entre sistemas, mas minha historia nao começa assim... </p>
                </div>
